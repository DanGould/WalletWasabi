...
/// mid-negotiation before the send flow could broadcast anything. Policy (questions-W1 Q2):
...
public class PayjoinSenderManager : PeriodicRunner
{
	...
	private async Task BroadcastAsync(Transaction fallbackTx, CancellationToken cancel)
	{
		...
		// Recovery metric (questions-W1 Q2): frequent crash-recovery broadcasts are the
		// signal for prioritizing true pending-async sends (lane W4).
